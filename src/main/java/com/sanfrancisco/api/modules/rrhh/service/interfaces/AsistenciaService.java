...
public interface AsistenciaService {
    ...
    // ── Marcado self-service (clock-in / clock-out) del empleado autenticado ──
    AsistenciaResponse marcarEntrada(Integer usuarioId);
    AsistenciaResponse marcarSalida(Integer usuarioId);
    List<AsistenciaResponse> misAsistencias(Integer usuarioId);
}
